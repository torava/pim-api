import { mockAttributes, mockCategories, mockProducts } from '../setupTests';
...
describe('products utils', () => {
  it('should get product category min max attributes', () => {
    const result = getProductCategoryMinMaxAttributes(mockStrippedCategories[3], undefined, mockProducts[0], undefined, 1, mockStrippedCategories, [], mockAttributes);
  ...
  it('should get product category min max attributes with food unit attribute', () => {
    const result = getProductCategoryMinMaxAttributes(mockStrippedCategories[3], undefined, mockProducts[0], mockAttributes[2], 5, mockStrippedCategories, [], mockAttributes);
  ...
  it('should resolve product attributes by with food unit attribute', () => {
    const product = mockProducts[0];
    const attributeIds = [1, 5];
