...
for (let first = 100; first < 120; first+= 20) {
...
console.log(first, rect.width, rect.height, rect.width*rect.height, difference, difference-old_diff);
...
src.delete(); dst.delete(); prev.delete();